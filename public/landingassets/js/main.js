$(function() {
    ...
    $('.container').imagesLoaded(function () {
        ...
        $('.ourevents-menu ul').on('click', 'li', function () {
        ...
        $('.ourevents-menu ul li').on('click', function (event) {
