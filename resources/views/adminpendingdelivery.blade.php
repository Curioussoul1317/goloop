                                ...
                                <div class="card border border-primary">
                                    <div class="card-header">
                                        <strong class="card-title">{{$vieworder->product->name}}
                                            <small>
                                                @if ($vieworder->delivered == 1)
                                                @else
                                                <span class="badge badge-danger float-right mt-1"> <a class="btn btn-danger btn-sm" href="{{route('AdminPurchase.update', ['id'=>$vieworder->id,'update'=>$vieworder->id])}}" style="width:100%">
                                                        Delivered</a></span>
                                                @endif
